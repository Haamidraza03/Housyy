  ...
  return (
    ...
    <div style={{marginTop:"70px"}} className='text-dark'>
      ...
      <div className='row justify-content-center text-center mt-5'>
        ...
        <div className="col-md-2 text-warning mb-5" data-aos="zoom-in" data-aos-duration="2000" data-aos-easing="ease-in-out"><span className='fs-1'><SlEnvolope/></span><p>G-mail</p></div>
